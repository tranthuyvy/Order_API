package com.example.androidgiuaky.Adapter;
...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.tvNameUserOder.setText(userName);
        viewHolder.tvPhone.setText(phoneNumber);
        viewHolder.tvAddress.setText(userAddress);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        PutOrderByOrderID(Math.toIntExact(order.getOrderId()),order);
    ...
    //cập nhật trạng thái đơn hàng lên API
    private void PutOrderByOrderID(int orderID , Order order){
        ApiService.apiService.PutOrderByOrderID(orderID, order).enqueue(new Callback<Order>() {
            @Override
